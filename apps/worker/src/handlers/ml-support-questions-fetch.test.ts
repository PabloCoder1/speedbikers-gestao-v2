...
describe("fetchSupportQuestions", () => {
  ...
  it("página vazia encerra sem persistir nada, com UMA chamada só", async () => {
    // Uma chamada, não duas: a sonda de diagnóstico de D-091 viveu aqui entre
    // 2026-08-25 e 2026-08-26 e saiu depois de responder o que precisava.
