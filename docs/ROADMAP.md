...
- [ ] **Frete: quem paga, na central** — o subsídio do Mercado Livre e o frete grátis dos compradores no período, depois de alguns dias de dado; recuperar os 90 dias (~70 mil chamadas de `/costs`) só se o dono quiser
