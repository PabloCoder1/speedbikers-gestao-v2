...
- [x] **Ads: sinais e recomendações** por campanha — `get_sinais_ads` e `/central/ads`: crítico, ROAS abaixo de 80% da meta, atenção (CPC e conversão, gasto e ROAS) e oportunidade de escala, com interpretação por CTR e conversão contra a mediana das campanhas e lucro estimado pela margem média (premissa declarada); dias de Ads que o Mercado Livre ainda não consolidou ficam fora dos julgamentos também na central e no faturamento — ✔ código 2026-09-23 · D-398. Migration `20260923195000`
