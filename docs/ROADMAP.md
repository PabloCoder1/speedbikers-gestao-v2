...
- [ ] **Remedir o custo do Realtime depois de D-199.** Ele era **43,4%** de todo o tempo do banco (D-198) porque a decodificação lógica lê todo o WAL, e as métricas eram a maior produtora. Com a convergência no ar, o número precisa ser medido de novo antes de qualquer conclusão sobre o Realtime em si.
