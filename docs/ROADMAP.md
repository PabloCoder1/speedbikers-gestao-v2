...
- [ ] **Frete: o detector usa as medidas** — pares de tamanho parecido, o declarado contra o cobrado e o motivo "medida suspeita"; depois de ver a cobertura real de `shipment_packages` e da sonda do anúncio
