...
- [ ] **Onde o cast É redundante, removê-lo — por sítio, com critério.** A pergunta é "a RLS pode esconder esta linha deste leitor?". Onde a resposta é não, o cast só esconde a cardinalidade e vale removê-lo. Onde é sim, ele fica. Não há ganho que justifique varrer os 11 de uma vez.
