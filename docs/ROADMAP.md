...
> Atualizado em 2026-08-27, junto com a limpeza de textos congelados — a versão anterior desta seção tinha parado em D-088 enquanto o corpo do checklist (acima) já registrava até D-097.
...
**Pendências fora da Fase 7B**: configurar o painel do Mercado Livre (🔴, ação humana — `docs/HANDOFF.md`), exercitar o primeiro envio real de resposta (🟡), operacionalizar o aviso de orçamento de IA (código completo em D-100, 2026-08-27 — falta deploy autorizado + 11º job do Scheduler), e as melhorias incrementais da Fase 7 (planner/streaming, expansão de “O que aconteceu?”, estruturação de sugestões por IA) — nada disso deve ser declarado concluído.
