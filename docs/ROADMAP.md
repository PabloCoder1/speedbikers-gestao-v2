...
**Pendências fora da Fase 7B**: configurar o painel do Mercado Livre (🔴, ação humana — `docs/HANDOFF.md`), exercitar o primeiro envio real de resposta (🟡), o mecanismo de aviso de orçamento de IA (D-082), e as melhorias incrementais da Fase 7 (planner/streaming, expansão de “O que aconteceu?”, estruturação de sugestões por IA) — nada disso deve ser declarado concluído.
