...
- [~] **A venda acha o SKU pelo user product** (13% dos itens vendidos em 30 dias saem sem SKU; 3.588 vínculos `USER_PRODUCT` parados) — 1ª parte ✔ código 2026-09-25: `order_items.user_product_id` gravado do próprio pedido, migration `20260925170000`. Falta: resolver pelo vínculo `USER_PRODUCT` quando não há vínculo por anúncio (o por anúncio vence), com a baixa de estoque e o efeito na reconciliação medido antes; e o histórico · D-362
