...
- [ ] Frontend: dados carregados por aba não aberta — a varredura não achou caso confirmado, mas o ângulo merece uma passada própria quando houver tela com abas de verdade.
