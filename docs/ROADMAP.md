...
- [ ] **Frete: quem paga, na central** — o subsídio do Mercado Livre e o frete grátis dos compradores no período, depois de alguns dias de dado (desde 25/09; em 4,7% dos pedidos as partes não fecham com o frete cheio, D-407); recuperar os 90 dias (~70 mil chamadas de `/costs`) só se o dono quiser
