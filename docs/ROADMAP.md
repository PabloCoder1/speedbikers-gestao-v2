...
- [ ] **Central de alertas persistida**: detectores do worker gravando em `actions` com tipos novos (frete, Ads, margem), para histórico, notificação e "resolvido" — hoje a lista é calculada a cada leitura
