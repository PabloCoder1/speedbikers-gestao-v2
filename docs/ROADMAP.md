...
- [ ] Full por conta como snapshot espelhado do ML, com eventos por diff — schema, job de captura (`sync.fulfillment.snapshot`) e detector de diff prontos em 2026-08-22, só para itens sem variação; falta disparo automático (Scheduler) e o caso com variação (`docs/DATABASE.md`)
