...
`/central` (D-394/D-395): indicadores contra o período anterior, meta do mês com projeção e imposto com vigência (cadastro em `/central/metas`). Migrations `20260923100000` e `20260923100100`; D-396 (frete 100% desde 25/06); D-397/D-399 `/central/frete`; D-398/D-401 `/central/ads`. Próxima: alertas (5J).
