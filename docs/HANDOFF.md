...
| **HEAD conhecido** | `564e994` (D-281, **D38**) — a **primeira gaveta do Figma** (`Drawer` + `.sb-drawer` + "Inspeção Rápida" em `/produtos`). Antes: `4ee0a5f` (D-279, D37c), quando a migração de superfícies fechou (D0→D25, D27→D36 + passe D37a/b/c; D26 recusada com medição, D-266) |
