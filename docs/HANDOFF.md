...
| **Produção** | 18/09: worker `worker-00014-c8z` e api `api-00012-t9g` em `0e5626e` (D-352; volta: `worker-00012-5md`/`api-00011-gtz` em `86afa36`). Vercel Production `dpl_3TtUDhnjDsVjJcvSp8zHASsXJQxX` (`c2cbd15`). Webhooks só em produção; Dev pausado (D-350). `v3-reconcile-balances` **despausado** em 18/09 (1ª rodada 19/09 06:00 BRT; D-352 §8). |
