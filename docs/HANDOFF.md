...
| **Frente atual** | **Produção** (D-350): criada e recebendo tráfego, com o Dev pausado. **Em curso:** a guarda contra baixa de estoque por venda anterior ao snapshot do ERP, com a compensação e o corte das notificações do backfill; o passo 10 da 8.2; e a triagem do relatório externo de desempenho. Design: sem item acionável (D-320 → D-327; o que ficou sem fonte está no arquivo de 2026-09-14). Com duas sessões no repo: portas 3000/3100 e `db reset` combinado. |
