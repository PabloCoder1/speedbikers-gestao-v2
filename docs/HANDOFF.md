...
| **Frente atual** | **Frente visual**: D18→D25 e D27→D29 entregues (+A3/A3b). **Próxima: D30 — Sugestões**; D26 (Tráfego) foi avaliada e RECUSADA por falta de fonte — zero colunas de impressão/Ads/reputação no schema (D-266). ⚠️ **`/cobertura` nunca foi migrada** (D-261). O guarda `check:table-styles` (D-262) reprova a migração pela metade e cobre **uma metade só** — tela que nunca declarou `.sb-table` depende da captura. Trilha 8B com P0 fechado (A–H) e em P1 |
