...
| **Branch** | `v3` (D-354 publicada e verificada em produção) |
| **HEAD conhecido** | `cfb7291` na `v3` — merge do PR #5 (D-354 usuários com nome, foto, suspender e remover; login e tela de carregamento). CI verde incluindo E2E/RLS, e a migration aplicada no Dev pela CI. Toda página nova precisa ser dinâmica (D-331): estática sai sem nonce. Armadilhas de ambiente/build em `docs/TESTING.md`. |
