...
**Verificação que NÃO foi feita:** nenhuma conversa real foi ingerida. A permissão "Comunicação pré e pós-venda" precisa estar concedida às contas e o painel de notificações continua não configurado, então o caminho ponta a ponta só se prova em produção, pela reconciliação de 10 minutos.
