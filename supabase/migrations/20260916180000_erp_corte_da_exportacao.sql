...
-- nao entra em organizacao reconciliada. Com o recorte, o Dev fica com o corte do parse no
-- alvo, e a planilha seguinte ja chega com o corte da exportacao pelo worker. O que a
...
-- esta funcao ganha EXECUTE para `service_role` em 20260916180100.
--
